...
<!--        <div class="slide-img" v-for="(image, idx) of listing.images" :key="idx" :style="{backgroundImage: `url(${image.url})`}">-->
...
<!--          <div class="action-btn" v-if="listing.contactMethods.includes('Email')">{{ listing._fastjoin.listedBy.email }}</div>-->
      ...
      <div class="middle">
        ...
        <div class="address">Available In <span>{{ $lget(listing, 'address.address.freeformAddress', 'No Address') }}</span></div>
      ...
      <div class="bottom">
        <div style="font-size: 1.5em; font-weight: 500; margin-bottom: 10px;">Location</div>
        ...
        <div style="font-size: 1.5em; font-weight: 500; margin-top: 10px;">Seller Information</div>
